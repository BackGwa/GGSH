...
<?php
    ...
    // 데이터 관리
    $subtitle[2] = '여러분의 소중한 정보들은 저희도 소중하니깐요.';
?>
...
<?php
    ...
    $content[0] = '
                    ...
                    <div class="display-content">
                        계급사회가 드디어 정식으로 출시되었습니다.
                    </div>

                    <div class="display-content">
                        직관적이고 깔끔해진 인터페이스로 셀 수 없을 정도로 추가된 기능들을 함께 쉽게 사용해보세요!
                    </div>
                    ...
                    <div class="display-content">
                        <b>> 다크 모드를 추가했어요.</b>
                        <br>더 이상은 밝은 화이트 테마 때문에 눈이 아플 걱정은 안해도 좋아요.
                    </div>
    ...
    $content[1] = '
                    ...
                    <div class="display-content">
                        ...
                        <br>호스팅 서비스는 "아이비 호스팅"을 사용하고 있으며, 무료 호스팅을 사용하고 있습니다.
                        이로 인해 트래픽 사용량에 제한이 있으며, 과도한 사용을 자제해주시길 바랍니다.
                    </div>
    ...
    // 데이터 관리
    $content[2] = '내용을 준비하고 있어요. 여러분의 정보를 안전하게 관리되고 있으니 걱정하지 말아요.';
?>